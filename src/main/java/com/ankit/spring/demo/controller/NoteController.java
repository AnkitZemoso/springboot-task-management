package com.ankit.spring.demo.controller;


import com.ankit.spring.demo.dto.Note;
import com.ankit.spring.demo.dto.Task;
import com.ankit.spring.demo.service.NotesService;
import com.ankit.spring.demo.service.TaskService;
...
public class NoteController {
    ...
    public String saveNote(@ModelAttribute("note") Note note,@RequestParam int taskId, Model model){
        try {
            ...
            note.setModifiedAt(new Date(System.currentTimeMillis()));
